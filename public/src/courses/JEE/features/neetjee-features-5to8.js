...
import { JEE_PERCENTILE_DATA, getJeeCollege, getJeePercentile } from "../rank-data.js";
...
export { DIFF_SUBJECTS, MOCK_QUESTIONS, addSRSCard, addToSRS, getDueSRSCards, mockTimerInterval, renderDifficulty, renderMock, renderPercentile, renderSRS, selectMockAnswer, setDifficulty, srsRate, startMock, submitMock };

if (typeof window !== "undefined") {
  Object.assign(window, { DIFF_SUBJECTS, MOCK_QUESTIONS, addSRSCard, addToSRS, getDueSRSCards, mockTimerInterval, renderDifficulty, renderMock, renderPercentile, renderSRS, selectMockAnswer, setDifficulty, srsRate, startMock, submitMock });
}
