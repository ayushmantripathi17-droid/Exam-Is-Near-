...
const SUBJECT_S3_CONST = {
  ...
  "units": [
    {
      "id": "u1",
      "name": "Introduction to Indian Constitution & Citizenship",
      "topics": [
    ...
    {
      "id": "u2",
      "name": "Fundamental Rights: Right to Equality (Art. 12–18)",
      "topics": [
    ...
    {
      "id": "u3",
      "name": "Fundamental Rights: Freedoms & Right against Exploitation (Art. 19–24)",
      "topics": [
    ...
    {
      "id": "u4",
      "name": "Fundamental Rights: Religion, Culture & Remedies (Art. 25–32 & 226)",
      "topics": [
    ...
    {
      "id": "u5",
      "name": "Directive Principles & Fundamental Duties (Art. 36–51A)",
      "topics": [
...
export { SUBJECT_S3_CONST };

if (typeof window !== "undefined") {
  Object.assign(window, { SUBJECT_S3_CONST });
}
