...
const SUBJECT_S3_CONTRACT = {
  ...
  "units": [
    ...
    {
      "id": "u3",
      "name": "Validity, Discharge & Performance of Contract",
      "topics": [
...
export { SUBJECT_S3_CONTRACT };

if (typeof window !== "undefined") {
  Object.assign(window, { SUBJECT_S3_CONTRACT });
}
