...
const SUBJECT_S3_FAMILY = {
  ...
  "units": [
    {
      "id": "u1",
      "name": "Introduction to Personal Laws",
      "topics": [
    ...
    {
      "id": "u2",
      "name": "Marriage Under Personal Laws",
      "topics": [
    ...
    {
      "id": "u3",
      "name": "Divorce & Dissolution Under Personal Laws",
      "topics": [
    ...
    {
      "id": "u4",
      "name": "Maintenance, Adoption & Guardianship",
      "topics": [
...
export { SUBJECT_S3_FAMILY };

if (typeof window !== "undefined") {
  Object.assign(window, { SUBJECT_S3_FAMILY });
}
