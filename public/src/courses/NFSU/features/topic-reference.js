import { _firestoreUpdating, pushToFirebase } from "../../../core/firebase-sync.js";
import { CURATED_CASELAWS } from "./reference-caselaws.js";
import { CURATED_DEFINITIONS } from "./reference-definitions.js";
import { CURATED_BAREACTS } from "./reference-bareacts.js";
...
import { formatSize, getFileIcon } from "./files-materials.js";
...
export { aiGenerateTopicRef, generateTopicRef, getCuratedRef, refAiCache, refAiLoading, refNotesOpen, refOpenTopic, refPyqOpen, refSubTab, renderCaseLawBlock, renderExplanationBlock, renderRefSubTabs, renderSubjectPyqAccordion, renderTopicRefModeSwitch, renderTopicRefNotesButton, renderTopicRefPanel, saveRefAiCache, setRefSubTab, setTopicRefMode, toggleSubjectPyq, toggleTopicRefExpand, toggleTopicRefNotes, topicRefKey, topicRefMode };

if (typeof window !== "undefined") {
  Object.assign(window, { aiGenerateTopicRef, generateTopicRef, getCuratedRef, refAiCache, refAiLoading, refNotesOpen, refOpenTopic, refPyqOpen, refSubTab, renderCaseLawBlock, renderExplanationBlock, renderRefSubTabs, renderSubjectPyqAccordion, renderTopicRefModeSwitch, renderTopicRefNotesButton, renderTopicRefPanel, saveRefAiCache, setRefSubTab, setTopicRefMode, toggleSubjectPyq, toggleTopicRefExpand, toggleTopicRefNotes, topicRefKey, topicRefMode });
}
