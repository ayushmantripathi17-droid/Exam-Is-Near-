import { DAYS, MONTHS } from "../../../shared/app-constants.js";
...
function playAlarmSound(){
  try{
    ...
    AppStateShared.activeAlarmAudio=ctx;
  }catch(e){}
}

function stopAlarmSound(){
  try{if(AppStateShared.activeAlarmAudio)AppStateShared.activeAlarmAudio.close();}catch(e){}
...
// ══════════════════════════════════════════════════════════════
function startTimer(){
  if(AppStateShared.timerInterval) return;
  state.timerRunning=true;
  AppStateShared.timerInterval=setInterval(()=>{
...
export { RINGTONES, _lastAlarmCheck, checkAlarms, dismissAlarm, pauseTimer, playAlarmSound, resetTimer, selectedRingtone, setRingtone, spawnStars, startTimer, stopAlarmSound, triggerAlarm, updateClock, updateTimerDisplay };

if (typeof window !== "undefined") {
  Object.assign(window, { RINGTONES, _lastAlarmCheck, checkAlarms, dismissAlarm, pauseTimer, playAlarmSound, resetTimer, selectedRingtone, setRingtone, spawnStars, startTimer, stopAlarmSound, triggerAlarm, updateClock, updateTimerDisplay });
}
