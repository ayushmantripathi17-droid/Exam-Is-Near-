...
// Subject: Fundamentals of Computer Organization & Embedded Systems
const SUBJECT_S1_COMPCORE = {
  "id": "s1-compcore",
  ...
  "units": [
    {
      "id": "u1",
      "name": "Basics of Computers; Boolean Algebra and Logic Circuits",
      "topics": [
    ...
    {
      "id": "u2",
      "name": "I/O Organization, Processor and Memory",
      "topics": [
    ...
    {
      "id": "u3",
      "name": "Embedded Systems and Operating System",
      "topics": [
    ...
    {
      "id": "u4",
      "name": "Office Automation Fundamentals",
      "topics": [
...
export { SUBJECT_S1_COMPCORE };

if (typeof window !== "undefined") {
  Object.assign(window, { SUBJECT_S1_COMPCORE });
}
