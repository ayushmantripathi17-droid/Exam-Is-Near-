...
// Subject: Basic Programming Concepts Using C
const SUBJECT_S1_C = {
  "id": "s1-c",
  "name": "Basic Programming Concepts Using C",
  "code": "SLBSL-S1-P5",
  "exam": "",
  "color": "#06D6A0",
  "icon": "🖥️",
  "units": [
    {
      "id": "u1",
      "name": "Pre-Programming Techniques & Getting Started with C",
      "topics": [
    ...
    {
      "id": "u2",
      "name": "Operators, Expressions and Control Structures",
      "topics": [
    ...
    {
      "id": "u3",
      "name": "Array, Pointer and Strings",
      "topics": [
    ...
    {
      "id": "u4",
      "name": "Functions, Structure, Union and File Handling",
      "topics": [
...
if (typeof window !== "undefined") {
  Object.assign(window, { SUBJECT_S1_C });
}
