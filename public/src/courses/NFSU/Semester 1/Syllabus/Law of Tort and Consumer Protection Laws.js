...
// Subject: Law of Tort and Consumer Protection Laws
const SUBJECT_S1_TORT = {
  "id": "s1-tort",
  "name": "Law of Tort and Consumer Protection Laws",
  "code": "SLBSL-S1-P2",
  "exam": "",
  "color": "#FF6B35",
  "icon": "⚖️",
  ...
  "units": [
    ...
    {
      "id": "u2",
      "name": "Principles of Liability and Specific Torts",
      "topics": [
    ...
    {
      "id": "u4",
      "name": "Consumer Protection and MV Act",
      "topics": [
...
export { SUBJECT_S1_TORT };

if (typeof window !== "undefined") {
  Object.assign(window, { SUBJECT_S1_TORT });
}
