import { isAdmin, state } from "../../../core/app-state.js";
import { CourseSelectorShared, getSubjects } from "../../../core/course-selector.js";
import { pomPause, pomReset, pomStart, pomState } from "../features/pomodoro-full.js";
import { getStreak, getSubjectPct, getTotalHours, switchView } from "../features/exam-dates-actions.js";
import { flashDecks, saveFlashDecks } from "../features/flashcards.js";
import { njSave, njState } from "../../../shared/exam-hub-state.js";
import { genId, showToast, today } from "../../../utils/helpers.js";
import { openProModal, verifyProOrThrow } from "../features/payments-pro.js";
import { S } from "../../../core/firebase-sync.js";
import { spawnStars } from "../features/clock-alarms-timer.js";
...
function openNavDrawer(){
  ...
  if(njBtn) njBtn.style.display=(CourseSelectorShared.activeCourse&&CourseSelectorShared.activeCourse!=='nfsu'&&CourseSelectorShared.activeCourse!=='cbse10'&&CourseSelectorShared.activeCourse!=='cbse12')?"":"none";
...
function exportProgressJSON(){
  const data={
    ...
    course:CourseSelectorShared.activeCourse||"nfsu",
...
export { closeNavDrawer, exportProgressJSON, exportProgressPDF, importProgressJSON, openNavDrawer, showKeyboardShortcuts };

if (typeof window !== "undefined") {
  Object.assign(window, { closeNavDrawer, exportProgressJSON, exportProgressPDF, importProgressJSON, openNavDrawer, showKeyboardShortcuts });
}
