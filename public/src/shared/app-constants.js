// Generic app constants (moods, note types, calendar labels) — not course-specific.
...
export { DAYS, MONTHS, MOODS, MOOD_LABELS, NOTE_ACC, NOTE_BG, NOTE_TYPES };

if (typeof window !== "undefined") {
  Object.assign(window, { DAYS, MONTHS, MOODS, MOOD_LABELS, NOTE_ACC, NOTE_BG, NOTE_TYPES });
}
