...
//    functions/index.js separately hardcoded a DIFFERENT live key ID
//    ("rzp_live_Sxwd6qLBExpLGL") for its fetchRazorpayFees stats call.
//    FIXED (2026-08-26): functions/index.js no longer hardcodes a second
//    key ID — fetchRazorpayFees now reads RZP_KEY_ID from Secret Manager,
//    same as checkout. See AUDIT.md §8.
// ══════════════════════════════════════════════════════════════
