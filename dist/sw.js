...
// Version: v9 — public/js/ replaced by real ES modules under public/src/
// (Vite build). Cache bumped so returning users' service workers evict
// ALL previously cached script URLs (which no longer exist under the new
// structure) and fetch the new app fresh. See MIGRATION_NOTES.md.
// ══════════════════════════════════════════════════════════

const CACHE_NAME = 'exam-is-near-v9';
const CACHE_STATIC = 'ein-static-v8';
